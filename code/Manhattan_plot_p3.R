...
# 路径设置
# ---------------------------
input_dir <- "/public/ojsys/eye/sujianzhong/yyh/Jiyuan/3_precess/"  # ← 修改为你的MLMA目录
output_dir <- "/public/ojsys/eye/sujianzhong/yyh/Jiyuan/GPB_plots/p3/" # ← 输出图片目录
...
plot_mlma_result <- function(file) {
  ...
  # 绘制 Manhattan 图
  # ---------------------------
  png(manhattan_png, width = 3200, height = 1600, res = 300)
  manhattan(df,
